...
Pod::Spec.new do |spec|
  ...
  #   * Finally, don't worry about the indent, CocoaPods strips it!
   spec.description  = "LTLibKit is test cocoapods"

  spec.homepage     = "https://github.com/xiezwgbits/LTLibKit"
  ...
  spec.source       = { :git => "https://github.com/xiezwgbits/LTLibKit.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'USE_FB' do |use_fb|
    use_fb.source_files = 'LTLibKit/USE_FB/leitinglib.framework/Headers/*.{h}'
